...
const AccordionExamples = () => (
	<Accordion>
		<Accordion.Item title='Danaus Plexippus'>
			<p>
		...
		<Accordion.Item title='Papilio Polyxenes'>
			<p>
		...
		<Accordion.Item title='Hyalophora Cecropia'>
			<p>
		...
		<Accordion.Item title='Deilephila Elpenor'>
			<p>
		...
		<Accordion.Item title='Papilio Troilus'>
			<p>
